    ...
    var body: some View {
        ...
        NavigationView {
            ZStack{
                ...
                ScrollView() {
                    VStack(alignment: .leading) {
                        ...
                        Text("Top Rated Hospitals:")
                            .font(.custom("PlayfairDisplay-ExtraBoldItalic", size: 26))
                            .padding(.horizontal)
                ...
                HStack{
                    NavigationLink(destination: barview1(), label: {Image(systemName:"house.fill")
                            .foregroundColor(Color(#colorLiteral(red: 0.7498469949, green: 0.8413919806, blue: 0.9537789226, alpha: 1)))
                            .frame(maxWidth: .infinity)
                    })
                    NavigationLink(destination: barview1(), label: {Image(systemName:"cross.vial")
                            .foregroundColor(Color(#colorLiteral(red: 0.7498469949, green: 0.8413919806, blue: 0.9537789226, alpha: 1)))
                            .frame(maxWidth: .infinity)
                    })
                    NavigationLink(destination: barview1(), label: {Image(systemName:"phone.circle.fill")
                            .foregroundColor(Color(#colorLiteral(red: 0.7498469949, green: 0.8413919806, blue: 0.9537789226, alpha: 1)))
                            .frame(maxWidth: .infinity)
                    })
                    NavigationLink(destination: barview1(), label: {Image(systemName:"person.circle.fill")
                            .foregroundColor(Color(#colorLiteral(red: 0.7498469949, green: 0.8413919806, blue: 0.9537789226, alpha: 1)))
                            .frame(maxWidth: .infinity)
                    })
